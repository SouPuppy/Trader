"""
带风险控制的 Logistic Regression 逻辑回归策略 Agent
使用逻辑回归模型预测股票未来收益，并通过 RiskManager 进行风险控制
"""
...
class LogisticAgentWithRiskControl(LogisticAgent):
    """
    带风险控制的逻辑回归策略 Agent
    
    继承自 LogisticAgent，添加风险控制功能
    投资策略与 LogisticAgent 完全一致，只是增加了风险控制
    """
    
    def __init__(
        self,
        name: str = "LogisticAgentWithRiskControl",
