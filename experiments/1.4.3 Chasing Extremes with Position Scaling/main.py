...
def chasing_extremes_with_position_scaling_backtest_single(
...
def chasing_extremes_with_position_scaling_backtest_all_stocks(
    ...
    for i, stock_code in enumerate(stock_codes, 1):
        ...
        try:
            result = chasing_extremes_with_position_scaling_backtest_single(
                stock_code=stock_code,
                initial_cash=initial_cash,
                extreme_threshold=extreme_threshold,
                lookback_days=lookback_days,
    ...
    if results:
        ...
        if successful_results:
            ...
            report_file = report.generate_multi_stock_report(
                results=results,
                strategy_name="Chasing Extremes with Position Scaling",
...
if __name__ == "__main__":
    # 对所有股票分别进行 Chasing Extremes 回测，生成综合报告
    chasing_extremes_with_position_scaling_backtest_all_stocks(
