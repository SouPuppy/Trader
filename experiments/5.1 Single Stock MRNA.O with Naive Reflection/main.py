...
def single_stock_strategy_with_reflection(
    ...
    for line in log_section("单股票交易系统（带每周反思层）"):
        logger.info(line)
                ...
                if last_reflection_date:
                    ...
                    try:
                        ...
                        if last_price and current_price and last_price > 0:
                            ...
                            logger.warning(f"[Reflection] 无法获取价格，跳过本次反思")
                            return
                    except Exception as e:
...
if __name__ == "__main__":
    # 执行单股票交易策略（带每周反思层）
    single_stock_strategy_with_reflection(
        stock_code="MRNA.O",
